...
#include "src/mesh/2d/Triangle.h"
#include "src/mesh/2d/Circle.h"
...
int main()
{
    ...
    std::cout << "SHADER_PATH: " << shaderPath << std::endl;

    triangle1->setVertexShaderPath(shaderPath + "vertexShader1.vert");
    triangle1->setFragmentShaderPath(shaderPath + "fragmentShader1.frag");
